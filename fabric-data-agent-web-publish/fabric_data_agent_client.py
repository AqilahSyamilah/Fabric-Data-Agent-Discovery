...
def main(questions: list, raw_response: bool = False, thread_name = None):
    ...
    TENANT_ID = os.getenv("TENANT_ID", "18992398-8b1b-449c-93ce-f574c7c2318c")
    DATA_AGENT_URL = os.getenv("DATA_AGENT_URL", "https://api.fabric.microsoft.com/v1/workspaces/d8c16307-bed1-413a-bdb2-33606f410c00/dataagents/0befebbe-ad65-421f-8c85-a52955e97511/aiassistant/openai")
